export enum Lab {
  ...
  GEOBOARD = 'GEOBOARD',
  DECIMAL_CALCULATOR = 'DECIMAL_CALCULATOR',
  SMART_CALCULATOR = 'SMART_CALCULATOR',
  ICE_CREAM = 'ICE_CREAM',
  RICH_PROBLEM_LAB = 'RICH_PROBLEM_LAB',
  CONNECTION_BUILDER = 'CONNECTION_BUILDER',
  STATISTICS_LAB = 'STATISTICS_LAB',
  STATISTICS_DETECTIVE = 'STATISTICS_DETECTIVE',
  STATISTICS_EXAMINER = 'STATISTICS_EXAMINER',
  TOWER_OF_HANOI = 'TOWER_OF_HANOI',
  ARCHITECT = 'ARCHITECT',
  PATTERN_TOWERS = 'PATTERN_TOWERS'
}
